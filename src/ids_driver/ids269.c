...
int ids269_initialize_button(void)
{
        ...
        // ids269_config(0x80, 0x0301);

        // // ids269_config(0x80, 0x0302);

        // HAL_Delay(1000);

        // // ids269_config(0x80, 0x0301);
        // // HAL_Delay(3000);
        // // ids269_config(0x80, 0x0304);
        ...
        // ret += ids269_config(0x86, 0x0000);
        // ret += ids269_config(0x87, 0x0001);
        // ret += ids269_config(0x88, 0x0000);
        // ret += ids269_config(0x89, 0x0000);
        // ret += ids269_config(0x8a, 0x197d);
        // ret += ids269_config(0x8b, 0x8000);
        ...
        // ret += ids269_config(0x93, 0x02ff);
        // ret += ids269_config(0x94, 0xa340);
        // ret += ids269_config(0x95, 0x0250);
        // ret += ids269_config(0x96, 0x0000);
...
int ids269_read_counts_button(void)
{
        ...
        // ids269_read_array(0x20, buf, 16);
        // printf("buf 20 - ");
        // for (size_t i = 0; i < 16; i++) {
        //         printf("%02x ", buf[i]);
        // }
        // printf("\n");
        // ids269_read_array(0x30, buf, 2);
        ...
        // if (ids269_read(0x8, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x9, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0xa, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0xb, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0xc, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0xd, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0xe, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0xf, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n\n\n", tmp, tmp);

        // if (ids269_read(0x10, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x11, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x12, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x13, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x14, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x15, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x16, &tmp))
        //         return -1;

        // printf("tmp - %d 0x%04x\n", tmp, tmp);

        // if (ids269_read(0x17, &tmp))
        //         return -1;
